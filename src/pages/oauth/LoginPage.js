...
const token = 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJraW1zaDI5NDhAa2FrYW8uY29tIiwibmlja25hbWUiOiJUaGlhZ28iLCJpZCI6MSwiZXhwIjoxNjc2OTczNjk1fQ.yVdRYyybXKExy2LT6-1dUNH9GK5IK3s3KyTgV2-XRjXwcb7qPtPQ0796txNGR-MVYpOI0cFzaWZXqzBLxyjxQQ';
  ...
  const onClick4 = () => {
    let code = new URL(window.location.href).searchParams.get('code')
      const kakaoLogin = async () => {
        axios
          .get(`localost:8080/api/oauth/token?code=${code}`)
          .then((res) => {
